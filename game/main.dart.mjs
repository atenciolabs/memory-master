...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1263: x0 => x0.length,
      _1338: () => globalThis.Module_soloud._createWorkerInWasm(),
      _1339: x0 => globalThis.Module_soloud._malloc(x0),
      _1340: (x0,x1,x2) => globalThis.Module_soloud.setValue(x0,x1,x2),
      _1342: x0 => globalThis.Module_soloud._free(x0),
      _1344: (x0,x1,x2,x3) => globalThis.Module_soloud._initEngine(x0,x1,x2,x3),
      _1347: (x0,x1) => globalThis.Module_soloud.getValue(x0,x1),
      _1350: () => globalThis.Module_soloud._dispose(),
      _1351: () => globalThis.Module_soloud._isInited(),
      _1352: (x0,x1,x2,x3,x4) => globalThis.Module_soloud._loadMem(x0,x1,x2,x3,x4),
      _1375: (x0,x1,x2,x3,x4,x5,x6) => globalThis.Module_soloud._play(x0,x1,x2,x3,x4,x5,x6),
      _1378: () => globalThis.Module_soloud._disposeAllSound(),
      _1384: () => globalThis.Module_soloud._getVisualizationEnabled(),
      _1457: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1458: (x0,x1) => x0.canShare(x1),
      _1459: (x0,x1) => x0.share(x1),
      _1462: (x0,x1) => ({files: x0,text: x1}),
      _1464: x0 => ({files: x0}),
      _1466: x0 => ({text: x0}),
      _1478: (x0,x1) => x0.getItem(x1),
      _1480: (x0,x1,x2) => x0.setItem(x1,x2),
      _1481: () => globalThis.removeSplashFromWeb(),
      _1482: Date.now,
      _1484: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1485: s => {
      ...
      _1487: () => typeof dartUseDateNowForTicks !== "undefined",
      _1488: () => 1000 * performance.now(),
      _1489: () => Date.now(),
      _1490: () => {
      ...
      _1492: () => new WeakMap(),
      _1493: (map, o) => map.get(o),
      _1494: (map, o, v) => map.set(o, v),
      _1495: x0 => new WeakRef(x0),
      _1496: x0 => x0.deref(),
      _1503: () => globalThis.WeakRef,
      _1507: s => JSON.stringify(s),
      _1508: s => printToConsole(s),
      _1509: (o, p, r) => o.replaceAll(p, () => r),
      _1511: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1512: s => s.toUpperCase(),
      _1513: s => s.trim(),
      _1514: s => s.trimLeft(),
      _1515: s => s.trimRight(),
      _1516: (string, times) => string.repeat(times),
      _1517: Function.prototype.call.bind(String.prototype.indexOf),
      _1518: (s, p, i) => s.lastIndexOf(p, i),
      _1519: (string, token) => string.split(token),
      _1520: Object.is,
      _1521: o => o instanceof Array,
      _1523: (a, i) => a.splice(i, 1)[0],
      _1526: a => a.pop(),
      _1527: (a, i) => a.splice(i, 1),
      _1528: (a, s) => a.join(s),
      _1529: (a, s, e) => a.slice(s, e),
      _1530: (a, s, e) => a.splice(s, e),
      _1531: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1532: a => a.length,
      _1534: (a, i) => a[i],
      _1535: (a, i, v) => a[i] = v,
      _1537: o => {
      ...
      _1538: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1540: o => o instanceof Uint8Array,
      _1541: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1542: o => o instanceof Int8Array,
      _1543: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1544: o => o instanceof Uint8ClampedArray,
      _1545: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1546: o => o instanceof Uint16Array,
      _1547: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1548: o => o instanceof Int16Array,
      _1549: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1550: o => o instanceof Uint32Array,
      _1551: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1552: o => o instanceof Int32Array,
      _1553: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1555: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1556: o => o instanceof Float32Array,
      _1557: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1558: o => o instanceof Float64Array,
      _1559: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1560: (t, s) => t.set(s),
      _1562: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1564: o => o.buffer,
      _1565: o => o.byteOffset,
      _1566: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1567: (b, o) => new DataView(b, o),
      _1568: (b, o, l) => new DataView(b, o, l),
      _1569: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1570: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1571: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1572: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1573: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1574: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1575: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1576: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1577: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1578: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1579: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1580: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1583: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1584: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1585: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1586: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1587: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1588: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1601: (ms, c) =>
      ...
      _1623: o => o.length,
      _1625: (o, i) => o[i],
      _1626: f => f.dartFunction,
      _1627: () => ({}),
      _1628: () => [],
      _1630: () => globalThis,
      _1631: (constructor, args) => {
      ...
      _1633: (o, p) => o[p],
      _1634: (o, p, v) => o[p] = v,
      _1635: (o, m, a) => o[m].apply(o, a),
      _1637: o => String(o),
      _1638: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      ...
      _1715: () => globalThis.Module_soloud.wasmWorker,
      _1719: (x0,x1) => x0.key(x1),
      _1720: x0 => x0.random(),
      _1723: () => globalThis.Math,
      ...
      _3614: () => globalThis.window,
      _3676: x0 => x0.navigator,
      _3940: x0 => x0.localStorage,
      _4063: x0 => x0.userAgent,
      _4114: x0 => x0.data,
      _4222: (x0,x1) => { x0.onmessage = x1 },
      _4270: x0 => x0.length,
      _12381: x0 => x0.name,
